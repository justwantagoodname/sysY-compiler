...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_Query = 16,                     /* Query  */
  YYSYMBOL_SelectorPrefix = 17,            /* SelectorPrefix  */
  YYSYMBOL_Selector = 18,                  /* Selector  */
  YYSYMBOL_AttrSelector = 19,              /* AttrSelector  */
  YYSYMBOL_AttrName = 20,                  /* AttrName  */
  YYSYMBOL_AttrOptions = 21,               /* AttrOptions  */
  YYSYMBOL_AttrOption = 22                 /* AttrOption  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NodeName", "String",
  "Prefix", "Number", "Slash", "DoubleSlash", "LeftBracket",
  "RightBracket", "At", "Equal", "Comma", "Or", "$accept", "Query",
  "SelectorPrefix", "Selector", "AttrSelector", "AttrName", "AttrOptions",
  "AttrOption", YY_NULLPTR
};
...
#define yyclearin       (yychar = QQEMPTY)
...
/* Backward compatibility with an undocumented macro.
   Use QQerror or QQUNDEF. */
#define YYERRCODE QQUNDEF
  ...
  if (yydebug)                                                            \
    {                                                                     \
      ...
      yy_symbol_print (stderr,                                            \
                  Kind, Value, scanner, result, last); \
      YYFPRINTF (stderr, "\n");                                           \
    }                                                                     \
} while (0)
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, yyscan_t scanner, QueryResult **result, QueryResult **last)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (scanner);
                 ...
                 yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, yyscan_t scanner, QueryResult **result, QueryResult **last)
{
  ...
  yy_symbol_value_print (yyo, yykind, yyvaluep, scanner, result, last);
  YYFPRINTF (yyo, ")");
}
...
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp,
                 int yyrule, yyscan_t scanner, QueryResult **result, QueryResult **last)
{
  ...
  for (yyi = 0; yyi < yynrhs; yyi++)
    {
      ...
      yy_symbol_print (stderr,
                       ...
                       &yyvsp[(yyi + 1) - (yynrhs)], scanner, result, last);
      YYFPRINTF (stderr, "\n");
    }
}
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, yyscan_t scanner, QueryResult **result, QueryResult **last)
{
  YY_USE (yyvaluep);
  YY_USE (scanner);
  YY_USE (result);
...
#define YYPOPSTACK(N)   (yyvsp -= (N), yyssp -= (N))
  ...
  yychar = QQEMPTY; /* Cause a token to be read.  */
...
yyerrlab:
  ...
  yytoken = yychar == QQEMPTY ? YYSYMBOL_YYEMPTY : YYTRANSLATE (yychar);
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  YY_ACCESSING_SYMBOL (yystate), yyvsp, scanner, result, last);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  YY_ACCESSING_SYMBOL (+*yyssp), yyvsp, scanner, result, last);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
